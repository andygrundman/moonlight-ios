...
- (void) drawStatsGraphs {
    ...
    switch ((int)io.DisplaySize.x) {
        ...
        case 874: // iPhone 16/17 Pro 874x402 3x
            graphW = 275.0f; graphH = 45.0f; break;
        case 912: // iPhone Air 912x420 3x
            graphW = 286.0f; graphH = 47.0f; break;
        case 956: // iPhone 17 Pro Max 956x440 3x
            graphW = 300.0f; graphH = 49.0f; break;
        // TODO:
        default:
